-- ============================================
-- HAWK CENTRAL SAMPLE DATA (SIMPLIFIED)
-- Insert test data for development
-- Run AFTER create_tables_simplified.sql
-- ============================================
...
-- Insert sample categories (6 categories)
...
-- Insert sample campus locations (6 locations)
INSERT INTO campus_locations (location_name, building_name, room_number, campus_area, is_active) VALUES
...
-- Insert sample event comments (4 comments)
INSERT INTO event_comments (event_id, user_id, comment_text) VALUES
...
-- Insert sample event photos (2 photos)
